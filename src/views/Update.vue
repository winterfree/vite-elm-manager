<template>
  <el-card>
    <el-result title="Github" sub-title="点击跳转到github页面进行下载">
      <template #icon>
        <svg style="background:white; width: 160px; height: 160px" viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg">
